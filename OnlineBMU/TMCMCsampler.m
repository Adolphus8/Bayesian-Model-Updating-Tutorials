function [output] = TMCMCsampler(varargin)
...
pnames = {'nsamples','loglikelihood','priorpdf','priorsamps','burnin','lastburnin','beta'};

dflts =  {[],[],[],[],[],0,0.2}; % define default values
      
[nsamples,loglikelihood,priorpdf,prior_samps,burnin,lastBurnin,beta] = ...
